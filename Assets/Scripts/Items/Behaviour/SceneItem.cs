...
namespace Items.Behaviour
{
    public class SceneItem : MonoBehaviour
    {
        ...
        [SerializeField] private float _maxVerticalPosiion;
        ...
        private void Awake()
        {
            ...
            float positionDifference = _maxVerticalPosiion - _minVerticalPosition;
            float sizeDifference = _maxSize - _minSize;
            _sizeModificator = sizeDifference / positionDifference;

        }

        private void OnMouseSown() => ItemClicked?.Invoke(this);
        ...
        public void PlayDrop(Vector2 position)
        {
            ...
            Vector2 movePosition = transform.position + new Vector3(Random.Range(-_dropRadius, _dropRadius),0);
        ...
        {
            float verticalDelta = _maxVerticalPosiion - _itemTransform.position.y;
